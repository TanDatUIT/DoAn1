set moduleName C_CNN_Pipeline_loop_for_a_Dense_0_loop_for_b_Dense_0
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {C_CNN_Pipeline_loop_for_a_Dense_0_loop_for_b_Dense_0}
set C_modelType { void 0 }
set C_modelArgList {
	{ Flatten_V int 16 regular {array 128 { 1 3 } 1 1 }  }
	{ Weights int 64 regular  }
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln5 int 63 regular  }
	{ out_Dense_V_1 int 16 regular {array 32 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "Flatten_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln5", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "out_Dense_V_1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ Flatten_V_address0 sc_out sc_lv 7 signal 0 } 
	{ Flatten_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ Flatten_V_q0 sc_in sc_lv 16 signal 0 } 
	{ Weights sc_in sc_lv 64 signal 1 } 
	{ sext_ln5 sc_in sc_lv 63 signal 3 } 
	{ out_Dense_V_1_address0 sc_out sc_lv 5 signal 4 } 
	{ out_Dense_V_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ out_Dense_V_1_we0 sc_out sc_logic 1 signal 4 } 
	{ out_Dense_V_1_d0 sc_out sc_lv 16 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Flatten_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "Flatten_V", "role": "address0" }} , 
 	{ "name": "Flatten_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Flatten_V", "role": "ce0" }} , 
 	{ "name": "Flatten_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "Flatten_V", "role": "q0" }} , 
 	{ "name": "Weights", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Weights", "role": "default" }} , 
 	{ "name": "sext_ln5", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln5", "role": "default" }} , 
 	{ "name": "out_Dense_V_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "out_Dense_V_1", "role": "address0" }} , 
 	{ "name": "out_Dense_V_1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_Dense_V_1", "role": "ce0" }} , 
 	{ "name": "out_Dense_V_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_Dense_V_1", "role": "we0" }} , 
 	{ "name": "out_Dense_V_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_Dense_V_1", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_24ns_24_4_1_U209", "Parent" : "0"},
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "8204", "Max" : "8204"}
]}
...
set Spec2ImplPortList { 
	Flatten_V { ap_memory {  { Flatten_V_address0 mem_address 1 7 }  { Flatten_V_ce0 mem_ce 1 1 }  { Flatten_V_q0 mem_dout 0 16 } } }
	...
	sext_ln5 { ap_none {  { sext_ln5 in_data 0 63 } } }
	out_Dense_V_1 { ap_memory {  { out_Dense_V_1_address0 mem_address 1 5 }  { out_Dense_V_1_ce0 mem_ce 1 1 }  { out_Dense_V_1_we0 mem_we 1 1 }  { out_Dense_V_1_d0 mem_din 1 16 } } }
}
