set moduleName D_CNN_Pipeline_VITIS_LOOP_26_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {D_CNN_Pipeline_VITIS_LOOP_26_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv4 int 16 regular {array 784 { 1 3 } 1 1 }  }
	{ OutModel0 int 16 regular {array 784 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "conv4", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv4_address0 sc_out sc_lv 10 signal 0 } 
	{ conv4_ce0 sc_out sc_logic 1 signal 0 } 
	{ conv4_q0 sc_in sc_lv 16 signal 0 } 
	{ OutModel0_address0 sc_out sc_lv 10 signal 1 } 
	{ OutModel0_ce0 sc_out sc_logic 1 signal 1 } 
	{ OutModel0_we0 sc_out sc_logic 1 signal 1 } 
	{ OutModel0_d0 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "conv4", "role": "address0" }} , 
 	{ "name": "conv4_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv4", "role": "ce0" }} , 
 	{ "name": "conv4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv4", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	conv4 { ap_memory {  { conv4_address0 mem_address 1 10 }  { conv4_ce0 mem_ce 1 1 }  { conv4_q0 in_data 0 16 } } }
