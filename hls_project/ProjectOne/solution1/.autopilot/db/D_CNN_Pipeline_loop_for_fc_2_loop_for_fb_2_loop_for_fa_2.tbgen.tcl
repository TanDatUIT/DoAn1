set moduleName D_CNN_Pipeline_loop_for_fc_2_loop_for_fb_2_loop_for_fa_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {D_CNN_Pipeline_loop_for_fc_2_loop_for_fb_2_loop_for_fa_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln100_mid2 int 63 regular  }
	{ select_ln95_2 int 5 regular  }
	{ zext_ln97 int 5 regular  }
	{ p_mid1483 int 11 regular  }
	{ OutPadConv2_V int 16 regular {array 7200 { 1 3 } 1 1 }  }
	{ s_V_2_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "denoiser_w","offset": { "type": "dynamic","port_name": "denoiser_w","bundle": "control_r"},"direction": "READONLY"},{"cName": "classifier_w","offset": { "type": "dynamic","port_name": "classifier_w","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln100_mid2", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln95_2", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln97", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "p_mid1483", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "OutPadConv2_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "s_V_2_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln100_mid2 sc_in sc_lv 63 signal 1 } 
	{ select_ln95_2 sc_in sc_lv 5 signal 2 } 
	{ zext_ln97 sc_in sc_lv 5 signal 3 } 
	{ p_mid1483 sc_in sc_lv 11 signal 4 } 
	{ OutPadConv2_V_address0 sc_out sc_lv 13 signal 5 } 
	{ OutPadConv2_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ OutPadConv2_V_q0 sc_in sc_lv 16 signal 5 } 
	{ s_V_2_out sc_out sc_lv 16 signal 6 } 
	{ s_V_2_out_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln100_mid2", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln100_mid2", "role": "default" }} , 
 	{ "name": "select_ln95_2", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "select_ln95_2", "role": "default" }} , 
 	{ "name": "zext_ln97", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln97", "role": "default" }} , 
 	{ "name": "p_mid1483", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "p_mid1483", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv2_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutPadConv2_V", "role": "q0" }} , 
 	{ "name": "s_V_2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "s_V_2_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_4ns_10ns_5ns_13_4_1_U85", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_24ns_24_4_1_U86", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln100_mid2 { ap_none {  { sext_ln100_mid2 in_data 0 63 } } }
	select_ln95_2 { ap_none {  { select_ln95_2 in_data 0 5 } } }
	zext_ln97 { ap_none {  { zext_ln97 in_data 0 5 } } }
	p_mid1483 { ap_none {  { p_mid1483 in_data 0 11 } } }
	OutPadConv2_V { ap_memory {  { OutPadConv2_V_address0 mem_address 1 13 }  { OutPadConv2_V_ce0 mem_ce 1 1 }  { OutPadConv2_V_q0 in_data 0 16 } } }
	s_V_2_out { ap_vld {  { s_V_2_out out_data 1 16 }  { s_V_2_out_ap_vld out_vld 1 1 } } }
}
