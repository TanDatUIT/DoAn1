...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename Flatten_V \
    op interface \
    ports { Flatten_V_address0 { O 7 vector } Flatten_V_ce0 { O 1 bit } Flatten_V_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'Flatten_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename out_Dense_V_1 \
    op interface \
    ports { out_Dense_V_1_address0 { O 5 vector } out_Dense_V_1_ce0 { O 1 bit } out_Dense_V_1_we0 { O 1 bit } out_Dense_V_1_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out_Dense_V_1'"
}
}
