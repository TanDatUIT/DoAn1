...
set name inference_top_sdiv_25ns_16s_16_29_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { out_Dense_V_address0 { O 4 vector } out_Dense_V_ce0 { O 1 bit } out_Dense_V_we0 { O 1 bit } out_Dense_V_d0 { O 16 vector } out_Dense_V_address1 { O 4 vector } out_Dense_V_ce1 { O 1 bit } out_Dense_V_q1 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln813_3 \
    op interface \
    ports { sext_ln813_3 { I 16 vector } } \
} "
}
