set moduleName C_CNN_Pipeline_loop_for_fc_1_loop_for_fb_1_loop_for_fa_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {C_CNN_Pipeline_loop_for_fc_1_loop_for_fb_1_loop_for_fa_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln35_mid2 int 63 regular  }
	{ select_ln30_2 int 4 regular  }
	{ p_mid1239 int 9 regular  }
	{ zext_ln32_1 int 4 regular  }
	{ MaxPool_S2_V int 16 regular {array 576 { 1 3 } 1 1 }  }
	{ s_V_6_out int 16 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "denoiser_w","offset": { "type": "dynamic","port_name": "denoiser_w","bundle": "control_r"},"direction": "READONLY"},{"cName": "classifier_w","offset": { "type": "dynamic","port_name": "classifier_w","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln35_mid2", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln30_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "p_mid1239", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln32_1", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "MaxPool_S2_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "s_V_6_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sext_ln35_mid2 sc_in sc_lv 63 signal 1 } 
	{ select_ln30_2 sc_in sc_lv 4 signal 2 } 
	{ p_mid1239 sc_in sc_lv 9 signal 3 } 
	{ zext_ln32_1 sc_in sc_lv 4 signal 4 } 
	{ MaxPool_S2_V_address0 sc_out sc_lv 10 signal 5 } 
	{ MaxPool_S2_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ MaxPool_S2_V_q0 sc_in sc_lv 16 signal 5 } 
	{ s_V_6_out sc_out sc_lv 16 signal 6 } 
	{ s_V_6_out_ap_vld sc_out sc_logic 1 outvld 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln35_mid2", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln35_mid2", "role": "default" }} , 
 	{ "name": "select_ln30_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "select_ln30_2", "role": "default" }} , 
 	{ "name": "p_mid1239", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "p_mid1239", "role": "default" }} , 
 	...
 	{ "name": "MaxPool_S2_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "MaxPool_S2_V", "role": "q0" }} , 
 	{ "name": "s_V_6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "s_V_6_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_24ns_24_4_1_U197", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln35_mid2 { ap_none {  { sext_ln35_mid2 in_data 0 63 } } }
	select_ln30_2 { ap_none {  { select_ln30_2 in_data 0 4 } } }
	p_mid1239 { ap_none {  { p_mid1239 in_data 0 9 } } }
	zext_ln32_1 { ap_none {  { zext_ln32_1 in_data 0 4 } } }
	MaxPool_S2_V { ap_memory {  { MaxPool_S2_V_address0 mem_address 1 10 }  { MaxPool_S2_V_ce0 mem_ce 1 1 }  { MaxPool_S2_V_q0 in_data 0 16 } } }
	s_V_6_out { ap_vld {  { s_V_6_out out_data 1 16 }  { s_V_6_out_ap_vld out_vld 1 1 } } }
}
